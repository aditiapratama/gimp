...
;
; (remixed by kf 2013 Added an interactive Path Dialog.. save by layer visibility upcomming )
;
...
;; Command is installed in "Layer->Save all layers..."
;;
...
(script-fu-menu-register "kf-save-all-layers" "<Image>/Layer/")
